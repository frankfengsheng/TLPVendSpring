...
/**
 * Created by Songjiancheng on 2016/4/18.
 */
public class LoadingDialog extends Dialog {
    ...
    private void init(String load,String tv1) {
        View contentView = View.inflate(m_Context, ResourceUtil.getLayoutId(m_Context, "activity_custom_loding_dialog_layout"), null);
