...
public class TLPFragmentSelection extends Fragment {
	...
	private void initdata(boolean query) {
		...
		if (null == m_Adapter) {
			...
			// 设置行数和列数
			m_RecyclerView.setPageSize(TcnCommon.getInstance().getGoodsRowNum(), TcnCommon.getInstance().getGoodsColumnNum());
